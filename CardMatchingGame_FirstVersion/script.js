class AudioController {
    constructor() {
        this.bgMusic = new Audio("source/audio/BGM.mp3");
        this.GameoverSound = new Audio("source/audio/Gameover.mp3");
        this.FlipSound = new Audio("source/audio/Flip.mp3");
        this.MatchSound = new Audio("source/audio/Match.mp3");
        this.VictorySound = new Audio("source/audio/Victory.mp3");
    }
